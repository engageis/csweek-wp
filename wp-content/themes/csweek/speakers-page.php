  ...
  <div class="container">
    <div class="row">
      <div class="span12">
        ...
        <div class="speaker-box"
          <img src="/wp-content/themes/csweek/images/Sean Moffitt - Speaker [Wiki Brands].png" class="speaker-image" />
          <h4><a href="http://ca.linkedin.com/in/moffittsean">Sean Moffitt</a></h4>
          <h5>Wiki Brands</h5>
        </div>

        <div class="speaker-box"
          <img src="/wp-content/themes/csweek/images/Lesley Mansford - Speaker [razoo].png" class="speaker-image" />
          <h4><a href="http://www.linkedin.com/in/lesleymansford">Lesley Mansford</a></h4>
          <h5>Razoo</h5>
        </div>

        <div class="speaker-box"
          <img src="/wp-content/themes/csweek/images/Shelley Kuipers - Speaker [Chaordix].png" class="speaker-image" />
          <h4><a href="http://ca.linkedin.com/in/shelleykuipers">Shelley Kuiper</a></h4>
          <h5>Chaordix</h5>
        </div>

        <div class="speaker-box"
          <img src="/wp-content/themes/csweek/images/Bart Becks - Speaker [iMinds].png" class="speaker-image" />
          <h4><a href="http://www.linkedin.com/in/bbecks">Bart Becks</a></h4>
          <h5>iMinds</h5>
        </div>

        <div class="speaker-box"
          <img src="/wp-content/themes/csweek/images/Jennifer Gustetic - Speaker [NASA].png" class="speaker-image" />
          <h4><a href="http://www.linkedin.com/in/jenngustetic ">Jennifer Gustetic</a></h4>
          <h5>NASA</h5>
        </div>

        <div class="speaker-box"
          <img src="/wp-content/themes/csweek/images/Francois Petavy - Speaker [eYeka].png" class="speaker-image" />
          <h4><a href="http://www.linkedin.com/fpetavy">Francois Petavy</a></h4>
          <h5>eYeka</h5>
        </div>

        <div class="speaker-box"
          <img src="/wp-content/themes/csweek/images/John 'Jay' B. Rogers Jr. - Speaker [Local Motors].png" class="speaker-image" />
          <h4><a href="http://www.linkedin.com/pub/john-b-rogers-jr/2/400/b4b">John 'Jay' B. Rogers Jr</a></h4>
          <h5>Local Motors</h5>
        </div>

        <div class="speaker-box"
          <img src="/wp-content/themes/csweek/images/Roger Yuen - Speaker [clozette].png" class="speaker-image" />
          <h4><a href="http://www.linkedin.com/pub/roger-yuen/0/114/4">Roger Yuen</a></h4>
          <h5>Clozette</h5>
        </div>

        <div class="speaker-box"
          <img src="/wp-content/themes/csweek/images/David Berkowitz - Speaker [360i] .png" class="speaker-image" />
          <h4><a href="http://www.linkedin.com/in/dberkowitz">David Berkowitz</a></h4>
          <h5>360i</h5>
        </div>

        <div class="speaker-box"
          <img src="/wp-content/themes/csweek/images/Ross Dawson - Speaker [Getting Results from Crowds].png" class="speaker-image" />
          <h4><a href="http://www.linkedin.com/in/futuristkeynotespeaker">Ross Dawson</a></h4>
          <h5>Getting Results from Crowds</h5>
        </div>

        <div class="speaker-box"
          <img src="/wp-content/themes/csweek/images/Simon Moss - Speaker [ImageBrief].png" class="speaker-image" />
          <h4><a href="http://www.linkedin.com/in/simonmoss">Simon Moss</a></h4>
          <h5>Image Brief</h5>
        </div>

        <div class="speaker-box"
          <img src="/wp-content/themes/csweek/images/Tim Leberecht - Speaker [frogdesign]" class="speaker-image" />
